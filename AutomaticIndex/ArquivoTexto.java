...
public class ArquivoTexto {
    ...
    */
    public void open(String nome){
        ...
        try {
           reader = Files.newBufferedReader(path1, Charset.defaultCharset());
            ...
            System.err.format("Erro na leitura do arquivo: 1", e);
        }    
    }
     ...
     * @return a próxima linha do arquivo.
     */
    public String getNextLine()  {
        try {
            ...
            System.err.format("Erro na leitura do arquivo: 2", e);
        }  
        return null;
    }   
    ...
    public void close() {
        try {
            ...
            System.err.format("Erro na leitura do arquivo: 3", e);
        }          
    }
}
